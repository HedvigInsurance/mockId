...
@Controller("/rp/v5")
open class RpController(val bankIdService: BankIdService) {
    ...
    companion object {
        ...
        private val log = LoggerFactory.getLogger(RpController::class.java)
    }
}

class SignResponse(val autoStartToken: String, val orderRef: String)

class SignRequest(val personalNumber: String?, val endUserIp: String, val userVisibleData: String, val userNonVisibleData: String?)
